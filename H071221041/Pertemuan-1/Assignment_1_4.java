...
public class Assignment_1_4 {
    ...
    public static String ubahHuruf(String kalimat) {
        ...
        //pembuatan objek dengan menyediakan suatu cara untuk menginisialisasi parameter dengan nama yang jelas
        //dan juga memiliki kesempatan untuk mengubah nilai parameter yang telah diset sebelumnya.
        for (String s : kata) {
            if (s.length() > 0) {
                char hurufPertama = Character.toUpperCase(s.charAt(0)); //method utk mngmbil char pda string sesuai index yg diinginkan
