public class Assignment_1_No7 {
    ...
    public int findIndex(String text) { // findIndex untuk mencari posisi index pertama pada suatu string 
        // Konversi teks ke huruf kecil agar casenya tidak memedulikan antara huruf kapital dan non kapital
        text = text.toLowerCase();
    
            // mencari indeks teks dalam array
            for (int i = 0; i < data.length; i++) {
                // metode equals() utk membandingkan dua String dalam array data
                if (data[i].toLowerCase().equals(text)) { // tolowerCase mengubah nilai string ke nilai string yang terdiri dari huruf kecil semua
