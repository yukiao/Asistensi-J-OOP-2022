...
public class Assignment_1_5 {
    public static void main(String[] args) {
        ...
        String[] arraytgl = tanggal.split("-"); // .split fungsi yang berguna untuk membuat sebuah string array dari sebuah string awal yang dipisahkan oleh tanda pemisah tertentu atau panjang tertentu
        
        int[] bln = new int [3]; // 3 panjang array
        for (int i = 0; i < arraytgl.length; i++) { 
            bln[i] =  Integer.parseInt(arraytgl[i]); // Integer.parseInt untuk mengkonversi nilai data tipe string menjadi tipe integer
        }
        inp.close();
