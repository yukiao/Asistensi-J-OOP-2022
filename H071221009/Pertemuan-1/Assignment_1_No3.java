...
public class Assignment_1_No3 {
    public static void main(String[] args) {
        ...
        try {
            ...
            inp.nextLine(); //nextLine utk baris selanjutnya agar bisa menginput nilainya/ yg di hobby akan langsung terprint nilai yg println akhir sebelum catch
